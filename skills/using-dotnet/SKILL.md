...
- **Match architecture to scope.** Simple CRUD doesn't need DDD or CQRS. A 20-line handler doesn't need 5 files. Scale the pattern to the problem. Prefer free/open-source: dotnet command-line handler over MediatR (commercial), built-in DataAnnotations over FluentValidation.
