...
> **Quick Ref**: Policy-based auth, not Role strings | Enable all JWT validations: ValidateIssuer/Audience/Lifetime/IssuerSigningKey | Global FallbackPolicy defaults to RequireAuthenticatedUser | Secrets in user-secrets/KeyVault, not in appsettings | Don't use AllowAnonymous unless explicitly a public endpoint
