...
> **Quick Ref**: Simple CRUD = single project + Controller | 50+ endpoints = VSA | Complex business rules = DDD | Need to swap persistence = Clean Architecture | Microservices = VSA inside each service | Don't use DDD/CQRS for simple CRUD
