...
> **Quick Ref**: Use using for IDisposable | Don't swallow exceptions | #pragma warning disable must be paired with restore | Don't use denylist for security validation | Don't use dynamic | Don't use new HttpClient() |
