...
> **Quick Ref**: Default to DataAnnotations | Cross-property rules via IValidatableObject | Configuration validation with IValidateOptions<T> + ValidateOnStart() | .NET 10 AddValidation() source-generated | Don't use FluentValidation |
