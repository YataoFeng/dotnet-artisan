...
面向 AI 编码代理的综合 .NET 开发技能库 — 支持 Claude Code、GitHub Copilot、VS Code、Cursor。
...
[![Auto-Evolve](https://img.shields.io/badge/Auto--Evolve-daily-4ade80)](.github/workflows/auto-evolve.yml)

融合自三大来源：原始 [dotnet-artisan](https://github.com/novotnyllc/dotnet-artisan) 深度框架 + 微软官方 [dotnet/skills](https://github.com/dotnet/skills) + [dotnet-claude-kit](https://github.com/codewithmukesh/dotnet-claude-kit) 好/坏代码模式。
...
| 工作流 | 频率 | 功能 |
|--------|------|------|
| `auto-evolve.yml` | 每日 10:47 | AI 分析上游仓库，自动应用新反模式，创建 PR |
| `self-heal.yml` | 每周日 11:23 | 检查断链、缺失章节、坏模式、尾随空白 |
| `ai-analyze-upstream.yml` | 手动/Issue | 深度 AI 分析指定上游仓库变更 |

全部使用 GitHub Models（GPT-4o-mini，免费层）。
